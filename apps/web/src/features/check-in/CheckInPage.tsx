...
export function CheckInPage() {
  ...
  useEffect(() => { if (selectedSpot) setPrecheck({ eligible: true, spotId: selectedSpot.id, distanceM: 0, allowedRadiusM: 100, accuracyM: accuracy ?? 0, reasons: [], estimatedReward: 0 }); }, [selectedSpot]);
