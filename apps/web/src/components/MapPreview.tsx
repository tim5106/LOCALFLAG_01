...
export function MapPreview({
  ...
  useEffect(() => {
    ...
    const point = new window.kakao.maps.LatLng(userLocation.lat, userLocation.lng);
  ...
  return (
    <section ref={mapElement} className="map-preview map-preview--fallback" aria-label="종로구 관광지 지도">
