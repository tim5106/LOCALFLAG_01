  ...
  return (
    ...
    >
      ...
      <span className="map-marker__pin">
        <span>{appearance.symbol}</span>
      </span>
      {checkInAvailable && <span className="map-marker__range">100m</span>}
      {checkInUnavailable && <span className="map-marker__area">AREA</span>}
      {visited && <span className="map-marker__check">✓</span>}
